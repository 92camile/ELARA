...
import { getStoryPhotos } from './stories.mjs';
...
export function createSitemap(
  ...
  const entries = [
    { route: '/', photos: [] },
    { route: '/lab/', photos: [] },
    { route: '/publications/', photos: [] },
    { route: '/students/', photos: [] },
    { route: '/projects/', photos: [] },
    { route: '/current-projects/', photos: [] },
    { route: '/volunteer/', photos: [] },
...
export function articleStructuredData(
  ...
  return {
    ...
    ...(story.updatedDate ? { dateModified: story.updatedDate } : {}),
    author: publisher,
    publisher,
    inLanguage: 'en',
    ...
    ...(getStoryPhotos(story).length
      ? {
          image: getStoryPhotos(story).map((photo) =>
            canonicalUrl(photo.src, base),
          ),
        }
      : {}),
